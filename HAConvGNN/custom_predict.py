...
def gen_pred(model, data, device, comstok, comlen, 
             batchsize, config, fid_set, strat='greedy'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', dest='dataprep', type=str, default='./final_data')
    ...
    print("ckpt_keys:", checkpoint.keys())
    ...
    testgen = batch_gen(seqdata, 'test', config, 
